...
public class SCUpdateRequest {
    ...
    public String toString() {
        return "SCUpdateRequest [id=" + id + ", rateCardId=" + rateCardId + ", component=" + component + ", baseline1="
                + baseline1 + ", baseline2=" + baseline2 + ", type=" + type + ", qoqRateCard=" + qoqRateCard
                + ", yoyRateCard=" + yoyRateCard + ", qoqBaseline1=" + qoqBaseline1 + ", yoyBaseline1=" + yoyBaseline1
                + ", qoqBaseline2=" + qoqBaseline2 + ", yoyBaseline2=" + yoyBaseline2 + ", week=" + week
                + ", spotLength=" + spotLength + ", channels=" + channels + "]";
    }
